...
const Login = () => {
  ...
  return (
    <div className="bg-purple-300 to-purple-500 flex items-center justify-center min-h-screen">
      <div className="bg-white p-6 sm:p-10 rounded-lg shadow-lg w-full max-w-sm">
        <h2 className="text-3xl font-bold text-purple-700 mb-4 text-center">Login</h2>
        <form onSubmit={loginSubmit}>
          <div className="mb-4">
            <label htmlFor="email" className="text-gray-900 font-bold mb-2">Email:</label>
            <input
              type="email"
              id="email"
              name="email"
          ...
          <p className="text-center">
            ...
            <Link to="signup" className="text-purple-900 hover:underline">Sign Up</Link>
          </p>
        </form>
      </div>
    </div>
